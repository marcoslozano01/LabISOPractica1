	...
	public JFrameEliminarUsuario() {
		...
		btnAltaUsuario.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					if(GestorUsuario.eliminarUsuario(textFieldLogin.getText(), textFieldPassword.getText())){
					...
					textPane.setText("No se ha podido eliminar  el usuario.¿Tal vez ya existe?");
				}
